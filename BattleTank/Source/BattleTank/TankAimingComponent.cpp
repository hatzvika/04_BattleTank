...
{
	// Find the difference between the current barrel rotation and the AimDirection
...
{
	// Find the difference between the current turret rotation and the AimDirection
